...
export const AddVehicleModal = ({ isOpen, onClose, onAdd }: AddVehicleModalProps) => {
            ...
            <div className="space-y-2">
              <div className="flex flex-col sm:flex-row gap-2">
                ...
                <button
                  ...
                  className="bg-green-500 text-white px-4 py-2 rounded hover:bg-green-600 disabled:bg-gray-300 disabled:cursor-not-allowed flex items-center justify-center gap-2 sm:flex-shrink-0"
                >
                  {decodingVin ? (
                    <>
